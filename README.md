...
This node was generated by the template in the
[Frontier](https://github.com/paritytech/frontier/tree/3297c466619934d462e0b845c1ab1e81906dcb18) project repository, at commit `Release branch polkadot-v0.9.39`.

Such template was originally forked from the
...
```
$ ./target/release/substrate-evm-node --dev
```

The node also supports to use manual seal (to produce block manually through RPC).

```
$ ./target/release/substrate-evm-node --dev --sealing=manual
# Or
$ ./target/release/substrate-evm-node --dev --sealing=instant
```
