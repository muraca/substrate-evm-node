...
// Runtime
use substrate_evm_runtime::{opaque::Block, Hash, TransactionConverter};
...
pub use crate::{
    client::{Client, SubstrateEVMRuntimeExecutor},
...
/// Build the import queue for the Substrate EVM runtime (aura + grandpa).
...
/// Build the import queue for the Substrate EVM runtime (manual seal).
    ...
    Executor: NativeExecutionDispatch + 'static,
{
    ...
    impl sp_inherents::InherentDataProvider for MockTimestampInherentDataProvider {
        async fn provide_inherent_data(
            ...
            TIMESTAMP.with(|x| {
                *x.borrow_mut() += substrate_evm_runtime::SLOT_DURATION;
...
pub fn build_full(
    ...
    new_full::<substrate_evm_runtime::RuntimeApi, SubstrateEVMRuntimeExecutor>(
...
> {
    ...
    let PartialComponents {
        ...
        other,
        ..
    } = new_partial::<substrate_evm_runtime::RuntimeApi, SubstrateEVMRuntimeExecutor, _>(
        config,
        eth_config,
