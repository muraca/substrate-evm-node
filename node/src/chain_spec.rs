        ...
        move || {
            DevGenesisExt {
                genesis_config: testnet_genesis(
                    wasm_binary,
                    // Sudo account
                    AccountId::from_str("1794E6cBaA39a79c3868f80D7df5A9F7E015370E").unwrap(),
                    // Pre-funded accounts
                    vec![AccountId::from_str("1794E6cBaA39a79c3868f80D7df5A9F7E015370E").unwrap()],
